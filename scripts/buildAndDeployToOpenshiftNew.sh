...
ROUTE_HOST=acmeair${GROUP}$(echo ${EXTERNAL_REGISTRY} | awk '{gsub("default-route-openshift-image-registry","");print $1}')
...
${BUILD_TOOL} pull --platform linux/amd64 docker.io/library/mongo:latest
${BUILD_TOOL} tag docker.io/library/mongo:latest ${IMAGE_PREFIX_EXTERNAL}/mongo:latest
${BUILD_TOOL} push ${IMAGE_PREFIX_EXTERNAL}/mongo:latest

cd "$(dirname "$0")"
cd ..
kubectl delete -f ${MANIFESTS}
mvn clean package
${BUILD_TOOL} build --platform linux/amd64 --pull -t ${IMAGE_PREFIX_EXTERNAL}/acmeair-mainservice-java:latest --no-cache -f ${DOCKERFILE} .
...
kubectl delete -f ${MANIFESTS}
mvn clean package
${BUILD_TOOL} build --platform linux/amd64 --pull -t ${IMAGE_PREFIX_EXTERNAL}/acmeair-authservice-java --no-cache -f ${DOCKERFILE} .
...
kubectl delete -f ${MANIFESTS}
mvn clean package
${BUILD_TOOL} build --platform linux/amd64 --pull -t ${IMAGE_PREFIX_EXTERNAL}/acmeair-bookingservice-java --no-cache -f ${DOCKERFILE} .
...
then
  ...
  sed -i.bak "s@docker.io/library/mongo:latest@${IMAGE_PREFIX}/mongo:latest@" ${MANIFESTS}/deploy-acmeair-bookingservice-java.yaml
fi
...
sed -i.bak "s@${IMAGE_PREFIX}/mongo:latest@docker.io/library/mongo:latest@" ${MANIFESTS}/deploy-acmeair-bookingservice-java.yaml
...
kubectl delete -f ${MANIFESTS}
mvn clean package
${BUILD_TOOL} build --platform linux/amd64 --pull -t ${IMAGE_PREFIX_EXTERNAL}/acmeair-customerservice-java --no-cache -f ${DOCKERFILE} .
...
then
  ...
  sed -i.bak "s@docker.io/library/mongo:latest@${IMAGE_PREFIX}/mongo:latest@" ${MANIFESTS}/deploy-acmeair-customerservice-java.yaml
fi
...
sed -i.bak "s@${IMAGE_PREFIX}/mongo:latest@docker.io/library/mongo:latest@" ${MANIFESTS}/deploy-acmeair-customerservice-java.yaml
...
kubectl delete -f ${MANIFESTS}
mvn clean package
${BUILD_TOOL} build --platform linux/amd64 --pull -t ${IMAGE_PREFIX_EXTERNAL}/acmeair-flightservice-java --no-cache -f ${DOCKERFILE} .
...
then
  ...
  sed -i.bak "s@docker.io/library/mongo:latest@${IMAGE_PREFIX}/mongo:latest@" ${MANIFESTS}/deploy-acmeair-flightservice-java.yaml
fi
...
sed -i.bak "s@${IMAGE_PREFIX}/mongo:latest@docker.io/library/mongo:latest@" ${MANIFESTS}/deploy-acmeair-flightservice-java.yaml
